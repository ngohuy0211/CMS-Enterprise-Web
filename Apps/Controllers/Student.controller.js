...
async function Dashboard(req, res) {
  ...
  return res.render("TutorAndStudent/dashboard/index", {
    data: { user_id: req.params.user_id, Role: Role.roleName },
  });
}
async function Get_Contact(req, res) {
  ...
  return res.render("TutorAndStudent/contact/index", {
    data: { Staff: List_staff },
  });
}
